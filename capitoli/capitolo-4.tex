...
\intro{In questo capitolo vengono descritti l'applicazione Sportwill, le tecnologie e gli strumenti utilizzati. Viene inoltre effettuata un'analisi dei requisiti per poi definire come le varie funzionalità sono state implementate. }\\
