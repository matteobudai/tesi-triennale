...
\begin{itemize}
	...
	\item Utilizzo di Dart che è un linguaggio facile da apprendere;  
...
\begin{itemize}
	...
	\item Dart Web: per le applicazioni destinate al Web. Include sia un compilatore del tempo di sviluppo (dartdevc) che consente di eseguire ed eseguire il debug dell'app Web Dart nel browser Chrome e vedere le modifiche quasi immediatamente, che un compilatore del tempo di produzione (dart2js) che fornisce suggerimenti per migliorare il codice Dart e rimuovere il codice inutilizzato. Entrambi i compilatori traducono Dart in JavaScript.\\
\end{itemize}
